...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null, "if you find yourself having to cross a poo river, here's how to do it...");
		...
		JOptionPane.showMessageDialog(null, "Piranhas are more " + a 
				+ " during the day, so cross the river at night. \n Piranhas are attracted to fresh " + b 
				+ " and will most likely take a bite out of your " + c 
				+ " if you are " + d 
				+ ". \n Whatever you do, if you have an open wound, try to find another way to get back to " + e 
				+ ". \n Good Luck!");
		// Make a pop-up for the final story. You can use \n to go to the next line
		JOptionPane.showMessageDialog(null, "you are a sinful boi");
